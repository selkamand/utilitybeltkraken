...
The goal of utilitybeltkraken is to simplify cohort-analysis of sample analysed with the kraken2 taxonomic classification system

## Installation

You can install the development version of utilitybeltkraken from [GitHub](https://github.com/) with:
